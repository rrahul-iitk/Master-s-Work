                ...
                {  if (j==0)
                    {
                      ...
                      f[j]=ap[i][j];
                      g[j]=-ae[i][j];
                      b[j]=(sc*dx*dy)+(q1*dy)+((as[i][j])*T3)+((an[i][j])*T[i+1][j]);
                    }
                   else
                    {
                      e[j]=-aw[i][j];
                ...
                if (j==0)
                    {
                      ...
                      f[j]=ap[i][j];
                      g[j]=-ae[i][j];
                      b[j]=(sc*dx*dy)+(q1*dy)+((an[i][j])*T4)+((as[i][j])*T[i-1][j]);
                    }
                   else
                    {
                      e[j]=-aw[i][j];
              ...
              if (j==0)
                    {
                      ...
                      f[j]=ap[i][j];
                      g[j]=-ae[i][j];
                      b[j]=(sc*dx*dy)+(q1*dy)+((as[i][j])*T[i-1][j])+((an[i][j])*T[i+1][j]);
                    }
                   else
                    {
                      e[j]=-aw[i][j];
                ...
                {  if (i==0)
                    {
                      ...
                      f[i]=ap[i][j];
                      g[i]=-an[i][j];
                      b[i]=(sc*dx*dy)+(q1*dy)+((as[i][j])*T3)+((ae[i][j])*T[i][j+1]);
                    }
                   else
                    {
                      e[i]=-as[i][j];
                      ...
                      if (i<n-1)
                       {
                         g[i]=-an[i][j];
                         b[i]=(sc*dx*dy)+(q1*dy)+((ae[i][j])*T[i][j+1]);
                       }
                      else
                       {g[i]=0;
                        b[i]=(sc*dx*dy)+(q1*dy)+((an[i][j])*T4)+((ae[i][j])*T[i][j+1]);
                       }
                     }
                  }
                else
     ...
     for (int i=0;i<n;i++)
     {
         for (int j=0;j<n;j++)
         {
             ...
             {if (i==0)
             {
                 if (j==0)
                 {
                    sum1= sum1+ (aw[i][j]*b[i])+(as[i][j]*T3)+((an[i][j])*T[i+1][j])+((ae[i][j])*T[i][j+1])-((ap[i][j])*T[i][j]);//add source term for source problem
                 }
                 else{
                     if(j<n-1)
                ...
                if (j==0)
                 {
                    sum1= sum1+ (aw[i][j]*a[i])+(as[i][j]*(T[i-1][j]))+((an[i][j])*T4)+((ae[i][j])*T[i][j+1])-((ap[i][j])*T[i][j]);//add source term for source problem
                 }
                 else{
                     if(j<n-1)
                 ...
                 {
                    sum1= sum1+ (aw[i][j]*a[i])+(as[i][j]*(T[i-1][j]))+((an[i][j])*T[i+1][j])+((ae[i][j])*T[i][j+1])-((ap[i][j])*T[i][j]);//add source term for source problem
                 }
                 else{
                     if(j<n-1)
